...
<!-- Main content -->
<form action="{{ route('panel.asset.editData',$dataaset->id) }}" method="put" enctype="multipart/form-data" id="form_data">
{{ csrf_field() }}
<div class="row">
    <div class="col-md-12">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12">Cover Art</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <center>
                            <img src="{{ $dataaset->cover_art }}" class="img-circle elevation-2 img-circle-custom mt-2" id="save_cover_art">
                            </center>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">Form Edit Data</div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pragita_asset_id" class="form-control" value="{{ $dataaset->pragita_asset_id }}">
                                </div>
                            </div>
                            @endif
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="new_rev" class="form-control" max-length="50" value="{{ $dataaset->new_rev }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ori_ver" class="form-control" max-length="50" value="{{ $dataaset->ori_ver }}">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" max-length="100" value="{{ $dataaset->title }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="custom-control custom-checkbox cursor-pointer">
                                                    ...
                                                    value="1" <?= $dataaset->notasi?'checked':'' ?>>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="performer" class="form-control" max-length="100" value="{{ $dataaset->performer }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="iswc" class="form-control" max-length="100" value="{{ $dataaset->iswc }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="isrc" class="form-control" max-length="100" value="{{ $dataaset->isrc }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_youtube_official" class="form-control" value="{{ $dataaset->link_youtube_official }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_youtube_others" class="form-control" value="{{ $dataaset->link_youtube_others }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_audio" class="form-control" value="{{ $dataaset->link_audio }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_lainnya" class="form-control" value="{{ $dataaset->link_lainnya }}">
                                </div>
                            </div>
