    ...
    <div class="row">
        <div class="col-md-12">
            <section class="content">
                ...
                <a href="?action=edit&users_id={{ request()->get('users_id') }}" class="btn btn-info btn-sm ml-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @if($datauser->dokumen_ktp)<a href="{{ $datauser->dokumen_ktp }}" target="_blank" class="btn btn-xs btn-info float-left mr-2"><i class="fas fa-download"></i></a>@endif
                                        <label for="">
                                            <b>NIK</b> 
                                        </label>
                                        <p style="margin-top: -13px;">
                                    ...
                                    <div class="col-md-6">
                                        @if($datauser->isnpwp)
                                            @if($datauser->dokumen_npwp)<a href="{{ $datauser->dokumen_npwp }}" target="_blank" class="btn btn-xs btn-info float-left mr-2"><i class="fas fa-download"></i></a>@endif
                                        @endif
                                        <label for="">
                                            <b>NPWP</b> 
                                        </label>
