                ...
                <table class="table table-bordered" id="table_data">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left">Komposisi</th>
                            @if(session()->get('login_panel')['is_admin'] == 1)
...
@section('js')
    <script>
        ...
        function getData(page=1){
            ...
            `);
            $.ajax({
                'url' : `{{ route('panel.pendapatan.dataPerComposer') }}`,
                'type' : 'GET',
                'data' : {
                            ...
                            table_data.append(`
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="row">
                                            <div class="col-12">
                                                <i class="far fa-list-alt cursor-pointer" 
                                                    title="Lihat Detail Pendapatan Composer ${val['work_id']} ${val['name']} - ${result.label_periode}" 
                                                    onclick="location='?action=detailcomposer&users_id=${val['id']}&tahunbulan=${val['tahunbulan']}'"
                                                    data-id="${val['id']}"></i>
                                            </div>
                                        </div>
                                    </td>
